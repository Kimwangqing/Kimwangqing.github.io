...
### 颜色
RGB：光的三原色
HSB：基于人眼视觉的色彩系统，色度（H）、饱和度（S）和亮度（B）
CMYK：基于油墨打印
WEB 安全：关于色域问题，有些颜色只能屏幕中显示，实际打印不出来
补色（油墨打印时使用）：打印时色彩不足时使用
...
* 按住 shift 键，同时向上或向下滑动描边磅数，可以使用描边磅数加粗或变细 10pt
* 按住 shift 键，同时点击填充色或边框色出现替代色彩用户界面

### 色板使用技巧
* 新建色板：使用吸管后，用新建色板将颜色固定在色板
* 新建颜色组：与新建色板一样将颜色固定在色板，但可以单独成列，更便于查找
![](../pic/Illustrator 教程/新建色板&新建颜色组.png)
* 勾选全局色后，该色板右下角会出现一个小三角，所有使用该全局色的色块可以统一变色
![](../pic/Illustrator 教程/全局色.png)
* 整个图片提取颜色并保存，并保存为 .ase 文件或 .ai 文件，以便下次使用
![](../pic/Illustrator 教程/提取整图颜色并保存.png)
* 还可以通过自带的固有色板更改颜色
![](../pic/Illustrator 教程/自带色板.png)
* 配色：color scheme designer (https://www.chinavid.com/color.html)
	* 在线配色完成后 > 截图 > 使用吸管 > 新建色板 > 新建色板组 > 将新建色板拖拽至新建色板组
* 重新着色：可以选用内部自带的配色方案
![](../pic/Illustrator 教程/重新着色.png)

### 渐变色使用技巧
* 打开渐变方式：属性面板&色板
![](../pic/Illustrator 教程/打开渐变方式.png)
* 属性面板（左栏）：双击渐变工具，右边跳出渐变属性
	1.可以反向渐变调节
	2.可以增加渐变滑块（向下拉就是删除渐变滑块）
![](../pic/Illustrator 教程/渐变属性面板.png)
* 属性面板（左栏）：单击渐变工具，跳出渐变批注轴（类似一把尺子）
    * 可以双击调出色块
	* 可以增加渐变滑块（向下拉就是删除渐变滑块）
	* 拉距长渐变平滑，拉距短渐变激烈

### 外观面板-图形样式
* 与左上角描边和填充的区别在于，外观面板可以新增加描边和填色
![](../pic/Illustrator 教程/外观面板.png)
* 按住 shift 键，同时向上或向下滑动描边磅数，可以使用描边磅数加粗或变细 10pt
* 可以像图层 一样拖拽改变颜色层次位置
![](../pic/Illustrator 教程/增加描边并改变图层.png)
* 填色可以设置不透明度并直接制作蒙板
![](../pic/Illustrator 教程/填色不透明度和蒙板.png)
* 填色可以调整颜色效果
![](../pic/Illustrator 教程/填色颜色效果.png)
*经常使用的是正片叠底*
*Note:想要改变谁,先要选中谁, 无法各个选择, 先 ctrl + A 全选, 再选择不同的图层*
* 保存图形样式(或直接拖拽至图形样式)提高复用性，之后绘制图形点击保存的图形样式后,可直接复制填色和描边样式
![](../pic/Illustrator 教程/图形样式-保存图形样式.png)
* 可以从图形样式库内选择样式
![](../pic/Illustrator 教程/图形样式库.png)
* 以涂抹为例, 可以对涂抹进行具体设置, 还可以将涂抹效果拖拽至别的图层
![](../pic/Illustrator 教程/涂抹具体设置.png)
![](../pic/Illustrator 教程/涂抹效果拖拽至别的图层.png)
* fs 效果和菜单里的效果是一样的
![](../pic/Illustrator 教程/与菜单里的效果一致.png)
* 线条叠加画公路, 之后可以拖拽到图形样式添加公路图形
![](../pic/Illustrator 教程/线条叠加画公路.png)
